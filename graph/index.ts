...
import { sightseeingNode } from "./nodes/sightseeing/sightseeingNode.js";
 ...
 *
 * Architecture:
 *   START -> router -> [arithmeticAgent | flightAgent | hotelAgent | restaurantAgent | selfieAgent | sightseeingAgent | unsupportedNode] -> END
 *
